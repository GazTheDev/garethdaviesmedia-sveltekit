...
<div class="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
	<h1 class="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black dark:text-white justify-center"> Blog | All Posts </h1>
	...
	{#if !searchValue}
		<h2 class="font-bold text-2xl md:text-4xl text-decoration-line: underline  tracking-tight mb-4 mt-8 text-black dark:text-white">
			Most Recent
		</h2>
