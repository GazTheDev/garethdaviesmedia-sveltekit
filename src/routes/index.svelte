...
<div class="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
	<h1 class="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black dark:text-white">
		Hey, I’m Gareth Davies
	</h1>
	<p class="prose text-gray-600 dark:text-gray-400 mb-16">
		I'm a developer and creator. I work as a freelance Web Developer and Designer.
	...
	<h2 class="font-bold text-2xl md:text-4xl tracking-tight mb-4 text-black dark:text-white"> Most Recent Blogposts </h2>
